...
public class      PoolControlPanel
   ...
   private class ListSelectionAction implements ListSelectionListener {
       ...
       public void valueChanged( ListSelectionEvent event ){
           ...
           System.out.println("PoolControlPanel "+info );
           ...
           try{
              ...
              System.err.println("Exception send "+ee ) ;
           }
       }
   }
          ...
          try{
              if( _subid == 5 ){
                  ...
                  if( _object instanceof JobInfo [] ){
                      ...
                      _queueList.setQueueInfo( null ) ;
                      System.err.println("Unexpected message class arrived : "+_object.getClass().getName() ) ;
                  }          
              }else if( _subid == 8 ){
