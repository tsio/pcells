            ...
            if( subid == 4 ){
                ...
                if( obj instanceof java.util.List ){
                   ...
                   for( Iterator i = list.iterator() ; i.hasNext() ; ){
                       System.out.println("Pool : "+i.next() ) ;
                   }
                   _monitor.preparePoolList( list ) ;
                }else{
                   System.err.println("Unexpected message id=4 : "+obj.getClass().getName()+" : "+obj);
                ...
                if( obj instanceof diskCacheV111.hsmControl.flush.FlushControlCellInfo ){
                  ...
                  _status.prepareFlushStatus( status ) ;
                   ...
                   System.err.println("Unexpected message id=5 : "+obj.getClass().getName()+" : "+obj);
