...
public class      JCostPanel
	 ...
	 if( source == _sectionPanelGroup ){
      ...
      public void actionPerformed( ActionEvent event ){
	     ...
	     try{
	         ...
	         System.err.println("Could start collector due to : "+ise);
		 return ;
	     }
		...
		//
	     ...
	     //System.out.println("Selected : "+_autoUpdate.getSelectedItem().getClass().getName());
	...
	*/
	 ...
	 if( table == null ){
	    System.err.println("Problem in publishing cost : cost table not yet present");
	    return null ;
	 }
	...
	*/
	 ...
	 for( Iterator it = sectionMap.entrySet().iterator() ; it.hasNext() ; ){
	    ...
	    System.out.println(" section : "+sectionName+" "+poolList);
	    //
	 ...
	 if( costMap == null ){
	    System.err.println("No costs available");
	    return ;
	 }
	 //
