...
public class      JPoolGroupList
   ...
   private void collectionFailed( Object obj ){
      System.out.println("Problem in collection PoolInfos : "+obj ) ;
   ...
   private void askForPoolsOfGroup( String poolGroup ){
      //System.out.println("Asking for pools of "+poolGroup) ;
      try{
   ...
   private void askForPoolGroups(){
      //System.out.println("Asking for all pool groups") ;
      try{
	 _connection.sendObject( "PoolManager" ,
                        	 "psux ls pgroup" ,
                        	  this ,
   ...
   public void domainAnswerArrived( Object obj , int subid ){
      System.out.println( "Answer ("+subid+") : "+obj.getClass().getName()+" "+obj.toString() ) ;
      if( _collectionState == WAITING_FOR_POOL_GROUPS ){
      
         if( ! ( obj instanceof Object [] ) ){ collectionFailed(obj) ; return ; }
	 Object [] array = (Object [])obj ;
	 
//	 System.out.println(""+array.length+" Pool Groups arrived" ) ;
	 ...
	 Object [] array = (Object [])obj ;
	 //System.out.println(""+array.length+" Pools arrived of *" ) ;
	 ...
	 //System.out.println(""+array.length+" Pools arrived of "+expectedPoolGroup ) ;
	 ArrayList list  = new ArrayList() ;
	 ...
	 if( _selectedPool >= _poolGroups.size() ){
	    ...
	    set.addAll( _poolGroups ) ;
            ...
            if( _collectLinks ){
               System.out.println("JPoolGroupList : switching to link, ask for link list");
	 ...
	 ArrayList list  = new ArrayList() ;
         ...
         System.out.println("Link list arrived : "+list) ;
         if( list.size() == 0 ){
            collectionDone() ;
            return ;
         }
         ...
         System.out.println("Got link entry : "+entry ) ;
         _linkListPosition ++ ;
   ...
   public void valueChanged( ListSelectionEvent event ){
	  ...
	  set.addAll(list);
       ...
       //System.out.println("Selected pools : "+set ) ;
       fireAction() ;
   }
