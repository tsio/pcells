...
public class SrmLinearSpaceComponent extends JComponent implements ListDataListener {
    ...
    private void updateValues(){
       ...
       if( ( _model == null ) || ( ( size = _model.getSize() ) < 5 ) ){
          System.err.println("Model content either null or < 5");
          return ;
       }
       try{
       ...
       System.out.println("Spaces : "+_totalSpace+" "+_inTokenUsed+" "+_inTokenFree+" "+_outTokenUsed+" "+_outTokenFree);		  

       }catch(Exception ee){
          System.err.println("Problem getting model data : "+ee);
       }
    ...
    public void contentsChanged( ListDataEvent event ){
       System.out.println("Content Changed SrmLinearComponent : "+event ) ;
       updateValues();
       repaint() ;
    }
