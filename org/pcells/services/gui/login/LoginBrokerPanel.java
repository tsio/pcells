...
//      header.setDefaultRenderer(_model.getRenderer());
   ...
   private void doorInfoArrived( String infoString , int pos ){
      ...
      if( ( rows == null ) || ( pos >= rows.length ) ){
         System.err.println("doorInfoArrived with illegal position : "+pos+" max "+rows.length);
         return ;
      }
      ...
      System.out.println(" arrived : "+pos+" "+children+" max "+maxChildren);
      ...
      if( _verifyBox.isSelected() ){
         ...
         for( int i = 0 ; i < info.length ; i++ ){
           ...
           try{
              ...
              System.err.println("Could't send 'ls children' to "+destination+" : "+ee);
